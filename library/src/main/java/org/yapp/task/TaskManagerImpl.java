...
/**
 * ClassName: TaskControllerImpl <br>
 * Description: 任务的管理类实现. <br>
 * Date: 2015-12-4 上午10:49:03 <br>
 */
public final class TaskManagerImpl implements TaskManager {
    ...
    public static void registerInstance() {
        ...
        y.Core.setTaskManager(instance);
    }
    ...
    public void autoPost(Runnable runnable) {
        ...
        if (Thread.currentThread() == Looper.getMainLooper().getThread()) {
            ...
            TaskProxy.mHandler.post(runnable);
        }
    }
    ...
    public void postDelayed(Runnable runnable, long delayMillis) {
        if (runnable == null) return;
        TaskProxy.mHandler.postDelayed(runnable, delayMillis);
    }
    ...
    public void run(Runnable runnable) {
        if (!TaskProxy.mDefaultExecutor.isBusy()) {
            TaskProxy.mDefaultExecutor.execute(runnable);
        } else {
    ...
    public void removeCallbacks(Runnable runnable) {
        TaskProxy.mHandler.removeCallbacks(runnable);
    }
